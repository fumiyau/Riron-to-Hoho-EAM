...
quietly esttab . using cohort5_disc_noconst_revise.csv, replace r(b) label wide nostar
...
quietly esttab . using cohort5_1_noconst_revise.csv, replace r(b) label wide nostar
quietly mlogit marevm year c.year##c.year i.redu i.statusx con i.fedu i.plv  i.redu##c.year i.redu##c.c.year##c.year if marev ==1
quietly estpost margins redu, at(year=(1(1)25) ) predict(outcome(2))
quietly esttab . using cohort5_2_noconst_revise.csv, replace r(b) label wide nostar
quietly mlogit marevm year c.year##c.year i.redu i.statusx con i.fedu i.plv  i.redu##c.year i.redu##c.c.year##c.year if marev ==1
quietly estpost margins redu, at(year=(1(1)25) ) predict(outcome(3))
quietly esttab . using cohort5_3_noconst_revise.csv, replace r(b) label wide nostar
